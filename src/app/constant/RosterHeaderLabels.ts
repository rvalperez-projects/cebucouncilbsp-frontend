export abstract class RosterHeaderLabels {
    ...
    public static memberPositions: Position[] = [
        ...
        {code: "09", title: "1."},{code: "09", title: "2."},
        {code: "09", title: "3."},{code: "09", title: "4."},
        {code: "09", title: "5."},{code: "09", title: "6."},
        {code: "09", title: "7."},{code: "09", title: "8."},{code: "x", title: ""},
        {code: "09", title: "1."},{code: "09", title: "2."},
        {code: "09", title: "3."},{code: "09", title: "4."},
        {code: "09", title: "5."},{code: "09", title: "6."},
        {code: "09", title: "7."},{code: "09", title: "8."},{code: "x", title: ""},
        ...
        {code: "09", title: "3."},{code: "09", title: "4."},
        {code: "09", title: "5."},{code: "09", title: "6."},
        {code: "09", title: "7."},{code: "09", title: "8."}
    ];
